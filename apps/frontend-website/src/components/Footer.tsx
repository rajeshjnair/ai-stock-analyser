...
import { Sparkles } from '@stock-analyser/ui';
...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-300 border-t border-border">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-accent-400 transition-colors"
                aria-label="GitHub"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">
              &copy; {currentYear} AI Stock Analyser. All rights reserved.
            </p>
